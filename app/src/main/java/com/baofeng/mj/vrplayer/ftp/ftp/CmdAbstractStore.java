...
abstract public class CmdAbstractStore extends FtpCmd {
    ...
    public void sendBroadCast(String name,long total,long current,int state){
        FtpActivity.CallBackReceiver callBackReceiver=FtpActivity.getCallBackReceiverInstance();
    ...
    public void doStorOrAppe(String param, boolean append) {
        ...
        storing: {
            ...
            try {
                if (storeFile.exists()) {
                    if (!append) {
                        ...
                        MediaUpdater.notifyFileDeleted(sessionThread.mContext,storeFile.getPath());
                    }
                }
            ...
            while (true) {
                ...
                case -1:
                    ...
                    sendBroadCast(null,0,fileSize,FtpActivity.ACTION_VRPLAYER_FTP_STATE_FINISH);
                    break storing;
                case 0:
                ...
                default:
                    try {
                        ...
                        if (sessionThread.isBinaryMode()) {
                            ...
                            fileSize+=numRead;
                            sendBroadCast(null,0,fileSize,FtpActivity.ACTION_VRPLAYER_FTP_STATE_ING);
                          //  Log.v("mm","sessionThread isBinaryMode numRead:"+fileSize );
                        } else {
                          //  Log.v("mm","sessionThread not isBinaryMode" );
        ...
        if (errString != null) {
            ...
            // been uploaded.
            MediaUpdater.notifyFileCreated(sessionThread.mContext,storeFile.getPath());
        }
