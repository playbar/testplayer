...
public class FileSizeUtil {
	 ...
	 * 获取缓存大小
	 */
	public static String getAppCacheSize(Context mContext){
		long cacheDirSize = getFileSize(mContext.getCacheDir());
		if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
			cacheDirSize += getFileSize(mContext.getExternalCacheDir());
		}
