...
public class SessionThread extends Thread {
    ...
    public void run() {
        ...
        if (sendWelcomeBanner) {
            writeString("220 SwiFTP " + ApkUtil.getVersionName(mContext) + " ready\r\n");
        }
    ...
    public SessionThread(Context mContext,Socket socket, DataSocketFactory dataSocketFactory, Source source) {
