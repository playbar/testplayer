...
public class PixelsUtil {
	...
	public static DisplayMetrics getDisplayMetrics(){
		if(displayMetrics == null){
			displayMetrics = MyAppliaction.getInstance().getResources().getDisplayMetrics();
		}
	 ...
	 * 获取横屏状态下屏幕宽度
	 */
	public static int getLandWidthPixels(){
		int widthPixels = getDisplayMetrics().widthPixels;
		int heightPixels = getDisplayMetrics().heightPixels;
	 ...
	 * 获取横屏状态下屏幕高度
	 */
	public static int getLandHeightPixels(){
		int widthPixels = getDisplayMetrics().widthPixels;
		int heightPixels = getDisplayMetrics().heightPixels;
